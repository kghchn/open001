...
import com.hubery.common.annotation.OperationLog;
...
public class LogAspect {
     ...
     */
    @Pointcut("@annotation(com.hubery.common.annotation.OperationLogDetail)")
...
//            operationLog.setTargetObjectId(Long.valueOf(annotation.targetObjectId()));
            operationLog.setTargetObjectId(annotation.targetObjectId());
